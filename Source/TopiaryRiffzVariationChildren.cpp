...
void EnablePoolComponent::setParent(TopiaryRiffzVariationComponent* p)
{
	parent = p;
} // setparent
...
void RandomNoteComponent::setParent(TopiaryRiffzVariationComponent* p)
{
	parent = p;
} // s
...
void SwingComponent::setParent(TopiaryRiffzVariationComponent* p)
{
	parent = p;
} // s
...
/////////////////////////////////////////////////////////////////////////
	...
	void VariationDefinitionComponent::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // setparent
...
/////////////////////////////////////////////////////////////////////////
	...
	void PoolChannelComponent ::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // setparent
...
/////////////////////////////////////////////////////////////////////////
	...
	void VelocityComponent::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // s
...
/////////////////////////////////////////////////////////////////////////
	...
	void TimingComponent::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // setParent
...
/////////////////////////////////////////////////////////////////////////
	...
	void VariationTypeComponent::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // setparent
...
/////////////////////////////////////////////////////////////////////////
	...
	void VelocityOffsetComponent::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // setparent
...
/////////////////////////////////////////////////////////////////////////
	...
	SwingQComponent::SwingQComponent()
	{
		...
		fourButton.setRadioGroupId(TopiaryRiffzModel::SwingQButtonIds::SwingQRadioID);
		fourButton.onClick = [this]
		{
			swingQ = TopiaryRiffzModel::SwingQButtonIds::SwingQ4;
			parent->setSwingQ();
		};
		...
		eightButton.setRadioGroupId(TopiaryRiffzModel::SwingQButtonIds::SwingQRadioID);
		eightButton.onClick = [this]
		{
			swingQ = TopiaryRiffzModel::SwingQButtonIds::SwingQ8;
			parent->setSwingQ();
		};
	...
	void SwingQComponent::setParent(TopiaryRiffzVariationComponent* p)
	{
		parent = p;
	} // setparent
