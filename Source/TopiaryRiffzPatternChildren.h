...
public:
	...
	TextButton addButton;		// adds note at current selection; adds at 0 0 0 if nothing selected
	TextButton addATButton, addCCButton, addPitchButton;
...
private:
	...
	static const int bWNarrow = 53;  // for add buttons in Riffz
